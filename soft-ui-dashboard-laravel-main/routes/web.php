...
use App\Http\Controllers\AiLaTrieuPhuController;
...
|
*/
Route::resource('/luotchoi',LuotChoiController::class);
Route::resource('/user',MemberController ::class);
Route::resource('/napthe',NapTheController ::class);
Route::resource('/admin', AdminController::class);
Route::resource('/linhvuc',LinhVucController ::class);
Route::resource('/ailatrieuphu',AiLaTrieuPhuController ::class);
